  ...
  return (
    <div className="bg-darkBlue">
      <div className="flex flex-col mx-auto px-5">
        ...
        <div
          dir="rtl"
          className="flex flex-col mx-auto justify-evenly pb-5 lg:flex-row"
        >
          <div className="flex-col w-80">
            ...
            <p className="text-white text-center	">
              با اتصال به بازارهای جهانی، تنوع ارزی و حجم معاملاتی بالا فراهم
              شده است.
            </p>
          </div>
          <div className="flex-col w-80">
            ...
            <p className="text-white align-center mx-auto text-center">
              اولویت رای بیت همیشه امنیت است و بنابراین متخصصان ما امن ترین
              پلتفرم را برای استفاده شما فراهم کرده اند.
            </p>
          </div>
          <div className="flex-col w-80">
            <div className="text-center">
